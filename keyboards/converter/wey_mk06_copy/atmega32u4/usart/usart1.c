...
ring_buffer_size_t usart1_recv_dequeue(uint8_t *data) {
  ring_buffer_size_t result;
  /* Prevent race conditions */
  ATOMIC_BLOCK(ATOMIC_RESTORESTATE)
  {
...
ring_buffer_size_t usart1_recv_peek(uint8_t *data, ring_buffer_size_t index) {
  ring_buffer_size_t result;
  /* Prevent race conditions */
  ATOMIC_BLOCK(ATOMIC_RESTORESTATE)
  {
...
void usart1_send_arr(const uint8_t *data, ring_buffer_size_t size) {
  ATOMIC_BLOCK(ATOMIC_RESTORESTATE)
  {
